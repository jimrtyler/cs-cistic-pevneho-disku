...
#GUI Variables
$FormTitleText = "Čistič disku od Jima Tylera (PowerShellEngineer.com)"
$SelectDiskLabelText = "Vyberte disk:"
$FreeSpaceLabelText = "Volné místo (gigabajty): "
$TotalSpaceLabelText = "Celkový prostor (gigabajty): "
$JunkFoundLabelText = "junk found (gigabajty):"
$CleanDiskBtnText = "Vyčistit disk *Odstranit soubory*"
$SpaceCleanedLabelText = "Vyčištěný prostor (gigabajty): "
$LogFileLabelText = "Nalezen soubor protokolu: $abcdefg"
$CreditLabelText = "Skript od Jima Tylera - PowerShellEngineer.com"
$LogFileLocatedText = "Nalezen soubor protokolu"
$AnalyzingDriveText = "Analýza disků..."
$BrowsersAreRunningText = "Prohlížeče běží... Upozornit uživatele..."
$PleaseCloseBrowsersText = "Zavřete prosím všechny webové prohlížeče a zkuste to znovu."
$CleaningDriveText = "Čištění disku..."
